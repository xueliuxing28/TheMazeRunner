...
public class Wall1Move : MonoBehaviour {
    ...
    public FightPlayer2Move playermove;
    ...
    void Obstacle7Move()
    {
        if (playermove.canMove)
        {
            ...
            else if (this.transform.position.x >37f)
            {
                if (!isMove)
                {
                    endpos = new Vector3(this.transform.position.x - dis, this.transform.position.y, this.transform.position.z);
            ...
            else if (this.transform.position.x <26f)
            {
                if (!isMove)
                {
                    endpos = new Vector3(this.transform.position.x + dis, this.transform.position.y, this.transform.position.z);
            ...
            else if (this.transform.position.x <= 37f && this.transform.position.x >= 26f && Status)
            {
                if (!isMove)
                {
                    endpos = new Vector3(this.transform.position.x - dis, this.transform.position.y, this.transform.position.z);
