...
public class EnemyControl1_04 : MonoBehaviour {
    ...
    void Obstacle4Move()
    {
        ...
        {
            if (this.transform.position.x < -2f&&this.transform.position.z>57f)//横向最初位置
            {
                if (!isMove)
                {
                    changedir = false;
            ...
            else if (this.transform.position.x >-2f && this.transform.position.x <4f && Status1&&this.transform.position.z>57f)//横向中间
            {
                if (!isMove)
                {
                    direction = new Vector3(1, 0, 0);
            ...
            else if (this.transform.position.x >-2f && this.transform.position.x <4f && !Status1&&this.transform.position.z>57f)//返回横向中间
            {
                if (!isMove)
                {
                    direction = new Vector3(-1, 0, 0);
            ...
            //纵向移动
            else if (this.transform.position.x > 4f && this.transform.position.z > 57f&&!Status1&&!changedir)//头
            {
                if (!isMove)
                {
            ...
            else if (this.transform.position.x > 4f && this.transform.position.z > 48f && this.transform.position.z < 57f &&Status2)//中转
            {
                if (!isMove)
                {
                    direction = new Vector3(0, 0, -1);
